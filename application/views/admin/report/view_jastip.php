      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Pemasukan Biaya Jasa</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
              ...
              <table class="table table-bordered" id="table-order" style="margin-bottom: 10px">
                <thead>
                  <tr>
                    ...
                    <th width="200">Total Biaya Jasa</th>
                  </tr>
                </thead>
                <tbody></tbody>
...
<script>
  ...
  $("#cetak").click(function() {
    window.open('<?php echo site_url('administrator/cetak_laporan_jastip?start_date=') ?>'+$("#periode").data('daterangepicker').startDate.format('YYYY-MM-DD H:mm:ss')+'&end_date='+$("#periode").data('daterangepicker').endDate.format('YYYY-MM-DD H:mm:ss'), '_blank');
  });
  ...
  $(document).ready(function() {
      oTable = $('#table-order').DataTable({ 
          ...
          "ajax": {
              "url": "<?php echo site_url('ajax/json_laporan_jastip') ?>",
              "type": "POST",
              "data": function ( data ) {
