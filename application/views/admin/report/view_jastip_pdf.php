    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="invoice-title">
                <h4>Laporan Pemasukan Biaya Jasa Periode <?php echo tanggal_indo(normalize_datetime($this->input->get('start_date'), 'Y-m-d')) ?> - <?php echo tanggal_indo(normalize_datetime($this->input->get('end_date'), 'Y-m-d')) ?></h4>
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr>
                            ...
                            <td class="text-right"><strong>Total Biaya Jasa</strong></td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($order as $row): ?>
                            <tr>
                                ...
                                <td class="text-right"><?php echo format_rupiah($row->total_fee) ?></td>
                            </tr>    
                        <?php endforeach ?>
                        <tr>
